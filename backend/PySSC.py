...
class PySSC:
	def __init__(self):
		if sys.platform == 'win32' or sys.platform == 'cygwin':
			self.pdll = CDLL("C:/Users/jgifford/Downloads/code4mst_py3/ssc.dll") 
		elif sys.platform == 'darwin':
			self.pdll = CDLL("C:/Users/jgifford/Downloads/code4mst_py3/ssc.dylib") 
		elif sys.platform == 'linux2':
			self.pdll = CDLL('C:/Users/jgifford/Downloads/code4mst_py3/ssc.so')   # instead of relative path, require user to have on LD_LIBRARY_PATH
		else:
