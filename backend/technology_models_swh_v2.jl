using JSON
defaults_file = "sam/defaults/defaults_swh.json" ### CHANGE
...
swh_module = @ccall hdl.ssc_module_create("swh"::Cstring)::Ptr{Cvoid} ### CHANGE
...
### Execute module
@ccall hdl.ssc_module_exec(swh_module::Ptr{Cvoid}, data::Ptr{Cvoid})::Cint
